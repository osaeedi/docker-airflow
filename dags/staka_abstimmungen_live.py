...
- [100143](https://data.bs.ch/explore/dataset/100143)
- [100144](https://data.bs.ch/explore/dataset/100144)
"""
...
with DAG('staka_abstimmungen_live', default_args=default_args, schedule_interval=None, catchup=False) as dag:
    dag.doc_md = __doc__
    process_upload = DockerOperator(
        ...
        container_name='staka_abstimmungen_live',
    ...
    ods_publish = DockerOperator(
        ...
        api_version='auto',
        auto_remove=True,
        command='python3 -m ods_publish.etl_id 100143,100144',
